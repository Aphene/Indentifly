...
const paymentHistory = () => {
  global.ajax.get(global.server+"PaymentHistory&UserID="+global.userID,paymentHistoryReply);

}

const paymentHistoryReply = (reply) => {
  global.payHistory=JSON.parse(reply);
  global.gotoPage("PaymentHistory");
}
    ...
    return (
        <div ref ={divRef} >
         ...
         <p></p>    
          ...
          <p></p>
          <Button  variant="contained" color="primary" onClick={() => {paymentHistory()}}> Payment History</Button>
          </Box>
      </div>
